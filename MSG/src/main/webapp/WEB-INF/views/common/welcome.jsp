...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/welcomeCal.css">
<link
			...
			<article>
				...
				<div style="width: 500px;" id="content2">
					<div style="width: 500px; margin-bottom: 34px; margin-top: 30px;"
						id="notice">
						<div id="calender">
							<div class="main" style="width: 500px; height: 300px;  border: 1px solid black;">
					...
					<div id="66" style="cursor: pointer;"
