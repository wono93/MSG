					...
					<table class="docuContentTb">
						<tr>
							...
							<td><input type="text" data-range="true"
								...
								class='far fa-calendar-alt startendicon' style='font-size: 32px'></i>
							</td>
							<td>잔여휴가</td>
							<td></td>
						</tr>
						...
						<tr>
							...
							<td colspan="3"><textarea name="" id="leavePurpose"
									cols="85" rows="6" placeholder="사유를 입력하세요"
						...
						<tr>
							...
							<td><input type="number" name="" id="surEmpNo"
								class="textIpt" placeholder="검색할 이름을 입력하세요"></td>
						</tr>
					</table>
				</div>
				<div class="tbRow">
