...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/allvacation.css">
            ...
            <article>
                ...
                <div class="content">
                    <div class="control">
                        <form>
                                ...
                                data-timepicker="true" data-date-format="yyyy-m-d D" data-time-format='hh:ii AA' autocomplete="off" minutesStep="10"/>
                                 <i class='far fa-calendar-alt starticon' id="start1" style='font-size:32px'></i>
                        <span class="wavepart">&nbsp;&nbsp;&nbsp;&nbsp;~</span>
                        <input type='text' id='timepicker-end' class='datepicker-here' data-language='ko' 
                                data-timepicker="true" data-date-format="yyyy-m-d D" data-time-format='hh:ii AA' autocomplete="off" minutesStep="10"/>
                        <i class='far fa-calendar-alt endicon' id="end1" style='font-size:32px'></i> 
                            <p>
                    ...
                    <table>
                        ...
                        <tr onclick="location.href='${pageContext.request.contextPath}/leave/select.do'">
                            <td>128</td>
                            <td>인사팀</td>
                            <td>안그래</td>
                            <td>연차</td>
                    ...
                    <div class="srchBar">
                        <div class="select-box">
                            ...
                            <ul class="select-box__list">
                                ...
                                <li>
                                    <label class="select-box__option" for="3" aria-hidden="aria-hidden">휴가종류</label>
                                </li>
                            </ul>
                        </div>
