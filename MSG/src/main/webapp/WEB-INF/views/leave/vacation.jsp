...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/vacation.css">
                ...
                <div class="content">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>0일</td>
                            <td>0일</td>
                            <td><p><a href="#test" rel="modal:open">
                    ...
                    <div class="srchBar">
                        <div class="select-box">
                            ...
                            <ul class="select-box__list">
                                ...
                                <li>
                                <label class="select-box__option" for="1" aria-hidden="aria-hidden">이름</label>
                                </li>
                            </ul>
                        </div>
        ...
        <div id="test" class="modal">
            ...
            <p>
                    <div class="checkbox custom">
                        조정할휴가
                        <input id="box2" class="css-checkbox" type="radio" name="abc" />
                        <label for="box2" class="css-label-yellow">연차</label> 
                        <input id="box1" class="css-checkbox" type="radio" name="abc" />
                        <label for="box1" class="css-label-red">포상</label> 
                    </div>
            </p>
            <p>
            ...
            <p>
                ...
                근거
                <form id="bookid"><p class="divice brd"> 전자문서:2020-GD001-0D3</p></form>
                </div>
            </p>
            <p>
            ...
            <a href="#" rel="modal:close"><button id="modalclo">취소</button></a>    <!-- 닫기버튼 -->
        </div>    
        </div>
